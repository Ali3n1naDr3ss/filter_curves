...
ax4.plot(vista_wavelength_y, vista_flux_y, label='VISTA-Y', color=nipy_spectral(0.1))
ax4.plot(vista_wavelength_j, vista_flux_j, label='VISTA-J', color=nipy_spectral(0.15))
ax4.plot(vista_wavelength_h, vista_flux_h, label='VISTA-H', color=nipy_spectral(0.2))
ax4.plot(vista_wavelenght_Ks, vista_flux_Ks, label='VISTA-Ks', color=nipy_spectral(0.25))
